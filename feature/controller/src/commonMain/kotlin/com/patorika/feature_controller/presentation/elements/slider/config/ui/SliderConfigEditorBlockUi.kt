package com.patorika.feature_controller.presentation.elements.slider.config.ui
...
import com.patorika.feature_controller.presentation.elements.slider.config.model.SliderConfigErrorType
import com.patorika.feature_controller.presentation.elements.slider.config.model.SliderConfigModel
import com.patorika.feature_controller.presentation.ext.filterDecimalInput
import com.patorika.feature_controller.presentation.ext.filterIntInput
...
fun SliderConfigEditorBlockUi(
    ...
    TextField(
        ...
        value = config.prefix,
        onValueChange = { new -> onModified(config.copy(prefix = new.limitEditorText())) },
    ...
    TextField(
        modifier = Modifier.fillMaxWidth(),
        value = config.suffix,
        onValueChange = { new -> onModified(config.copy(suffix = new.limitEditorText())) },
